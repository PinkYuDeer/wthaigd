package com.pinkyudeer.wthaigd.db;

import java.util.Collection;
import java.util.List;
import java.util.UUID;

import com.pinkyudeer.wthaigd.db.builder.AlterTableBuilder;
import com.pinkyudeer.wthaigd.db.builder.CreateTableBuilder;
import com.pinkyudeer.wthaigd.db.builder.DeleteBuilder;
import com.pinkyudeer.wthaigd.db.builder.DropTableBuilder;
import com.pinkyudeer.wthaigd.db.builder.InsertBuilder;
