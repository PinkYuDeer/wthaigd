...
public class RectConfigBuilder {
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder renderOffset(float x, float y) {
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder renderSizeMulti(float x, float y) {
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder rectSizeMulti(float x, float y) {
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder rectCenterOffset(float x, float y) {
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder backgroundColor(int color) {
        this.colorBg = color;
        return this;
    }
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder rectColor(int color) {
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder continuity(float index) {
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder rectEdgeSoftness(float softness) {
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder rounds(float topRight, float bottomRight, float topLeft, float bottomLeft) {
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder round(float radius) {
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder border(float thickness, float softness, float pos, int color) {
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder border(float thickness, float pos, int color) {
        this.borderThickness = thickness;
        this.borderPos = pos;
        this.colorBorder = color;
        return this;
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder borderSelect(boolean top, boolean bottom, boolean left, boolean right,
        boolean cutCorners) {
     ...
     * 设置边框选择
     *
     * @param borderSelect 边框选择数组，分别表示上、下、左、右边框的选择
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder borderSelect(float[] borderSelect, boolean cutCorners) {
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder shadow(float blur, float offsetX, float offsetY, int color) {
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder shadow2(float blur, float offsetX, float offsetY, int color) {
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder innerShadow(float blur, float offsetX, float offsetY, int color) {
     ...
     * @return 构建器实例，用于链式调用
     */
    public RectConfigBuilder innerShadow2(float blur, float offsetX, float offsetY, int color) {
     ...
     */
    public GLShaderDrawHelper.CustomRectConfig done() {
        if (useComplexShader) {
            if (useSimpleShader) throw new IllegalStateException("复杂矩形不可选择边框。");
            return new GLShaderDrawHelper.CustomRectConfig(
                renderOffset,
                renderSizeMulti,
                continuityIndex,
                colorBg,
